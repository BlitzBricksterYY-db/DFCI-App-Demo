# #: (for debugging) check all installed packages.
# import sys
...
api_key = os.getenv('AOAI_API_KEY', None) # setup in App service -> Environment variables; if test in local, make sure you specify this env variable with key value in advance in the console.
if not api_key:
    print("'AOAI_API_KEY' not set up correctly!", file=sys.stderr)
    sys.exit(1)
